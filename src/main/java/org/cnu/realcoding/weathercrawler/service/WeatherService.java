...
import org.cnu.realcoding.weathercrawler.api.ChampionApiClient;
import org.cnu.realcoding.weathercrawler.domain.CurrentWeather;
import org.cnu.realcoding.weathercrawler.repository.SummonerRepository;
...
public class WeatherService {
    ...
    @Autowired
    private ChampionApiClient openWeatherMapApiClient;
    @Autowired
    private SummonerRepository currentWeatherRepository;
    ...
    public void getCurrentWeatherPeriodicallyByCityName() {
        ...
        CurrentWeather currentWeather = openWeatherMapApiClient.getChampion(cityName);
